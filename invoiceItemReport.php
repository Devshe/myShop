            ...
            <tbody>
                <?php
                    ...
                    if(isset($_GET['from_date']) && isset($_GET['to_date']))
                    {
                        ...
                        $sql = "SELECT a.invoice_no,a.date,concat(c.first_name,' ',c.last_name) as customer, 
                        it.item_code,it.item_name,ic.category,it.unit_price FROM invoice a inner join customer c on a.customer=c.id
                        inner join invoice_master im on a.invoice_no=im.invoice_no 
                        inner join item it on it.id=im.item_id inner join item_category ic on ic.id=it.item_category 
